...
class TimeGameoverviewController : UIViewController ,NADViewDelegate, NADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        let score1 = ud.floatForKey("score1")
        let str  = String(format: "%.2f",score1)
        var hi_score1 = ud.floatForKey("hi_score1")
        let str0 = String(format: "%.2f",hi_score1)
        
        
        //スコアがハイスコアを上回ったら、ハイスコアを更新！
        if hi_score1 == 0.00 {
            
            ud.setFloat(score1, forKey: "hi_score1")
    ...
    func onPostToTwitter(sender : AnyObject) {
        ...
        // 投稿するテキストを指定.
        let theText = String(format: "けんけんぱっ！　タイムは %.2fでした！みんなもやってみよう！　　ダウンロードはこちらhttps://itunes.apple.com/us/app/kenkenpa-tsu!/id1082624420?mt=8　         #けんけんぱっ！", timeover1)
