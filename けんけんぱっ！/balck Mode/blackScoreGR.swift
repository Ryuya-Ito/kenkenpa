...
class blackScoregameoverviewController : UIViewController ,NADViewDelegate, NADInterstitialDelegate {
    
    //変数宣言
    private var nadView: NADView!
    
    var blackhi_score: Int = 0
    ...
    override func viewDidLoad() {
        ...
        let blackscore = ud.integerForKey("blackscore")
        var blackhi_score = ud.integerForKey("blackhi_score")
        
        // スコアがハイスコアを上回ったら、ハイスコアを更新！
        if blackscore > blackhi_score {
            ud.setInteger(blackscore, forKey: "blackhi_score")
            blackhi_score = blackscore
        }
        ...
        scorelabel.text = "Score : \(blackscore)";
        ...
        hilabel.text = "Best score : \(blackhi_score)";
    ...
    func MyButton(sender: UIButton){
        ...
        let Button: UIViewController = blackScorecountviewController()
    ...
    func onPostToTwitter(sender : AnyObject) {
        ...
        // 投稿するテキストを指定.
        myComposeView.setInitialText("けんけんぱっ！　スコアは\(blackscore)でした！みんなもやってみよう！　ダウンロードはこちらhttps://itunes.apple.com/us/app/kenkenpa-tsu!/id1082624420?mt=8　     #けんけんぱっ！")
