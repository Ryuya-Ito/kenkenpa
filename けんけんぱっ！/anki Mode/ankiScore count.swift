...
class ankiScorecountviewController : UIViewController {
    ...
    func counting(){
        ...
        if count == 1 {
            ...
            let countimage2 = UIImage(named: "countnumber3.png")
            myImage.image = countimage2
        ...
        if count == 4 {
            ...
            //移動するページの定義
            let myviewcontroller: UIViewController = ankiScoregameviewController()
