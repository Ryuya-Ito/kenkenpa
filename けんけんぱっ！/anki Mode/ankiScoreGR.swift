...
class ankiScoregameoverviewController : UIViewController ,NADViewDelegate, NADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        let ankiscore = ud.integerForKey("ankiscore")
        var ankihi_score = ud.integerForKey("ankihi_score")
        
        // スコアがハイスコアを上回ったら、ハイスコアを更新！
        if ankiscore > ankihi_score {
            ud.setInteger(ankiscore, forKey: "ankihi_score")
            ankihi_score = ankiscore
        }
        ...
        scorelabel.text = "Score : \(ankiscore)";
        ...
        hilabel.text = "Best score : \(ankihi_score)";
    ...
    func MyButton(sender: UIButton){
        ...
        let Button: UIViewController = ankiScorecountviewController()
    ...
    func onPostToTwitter(sender : AnyObject) {
        ...
        // 投稿するテキストを指定.
        myComposeView.setInitialText("けんけんぱっ！　スコアは\(ankiscore)でした！みんなもやってみよう！　ダウンロードはこちらhttps://itunes.apple.com/us/app/kenkenpa-tsu!/id1082624420?mt=8    #けんけんぱっ！")
