...
class ankiviewController : UIViewController ,NADViewDelegate, NADInterstitialDelegate {
    ...
    internal func score(sender: UIButton){
        ...
        let view: UIViewController = ankiScorecountviewController()
    ...
    internal func score1(sender: UIButton){
        ...
        let view1: UIViewController = ankiTimecountviewController()
