...
var timeover1: Float = 0.00

var score1: Int = 20

var timers = NSTimer()

class TimeGameviewController : UIViewController , ADFMovieRewardDelegate{
    ...
    override func viewDidLoad() {
        ...
        //0.01秒づつ呼び出す
        timers = NSTimer.scheduledTimerWithTimeInterval(0.01, target: self, selector: Selector("count0"), userInfo: nil, repeats: true)
    ...
    func count0() {
        ...
        timeover1 += 0.01
        timelabel.text = "\(timeover1)"
        
        let str = String(format: "%.2f", timeover1)//小数点２桁まで表示
        timelabel.text = str
        ...
        if scoreLabel.text == "0" {
            ...
            ud.setFloat(timeover1, forKey: "score1")
            
            let view: UIViewController = TimeGameoverviewController()
