...
class ScoreGameoverviewController : UIViewController,NADViewDelegate, NADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        hilabel.text = "Best score : \(hi_score)";
    ...
    func nadViewDidFinishLoad(adView: NADView!) {
        ...
        func MyButton(sender: UIButton){
            ...
            let Button: UIViewController = ScoreCountviewController()
    ...
    func onPostToTwitter(sender : AnyObject) {
        ...
        // 投稿するテキストを指定.
        myComposeView.setInitialText("けんけんぱっ！　スコアは\(score)でした！みんなもやってみよう！　　ダウンロードはこちら https://itunes.apple.com/us/app/kenkenpa-tsu!/id1082624420?mt=8　     #けんけんぱっ！")
