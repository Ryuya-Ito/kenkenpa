...
class kurayamiviewController : UIViewController ,NADViewDelegate, NADInterstitialDelegate {
    ...
    internal func score(sender: UIButton){
        ...
        let view: UIViewController = blackScorecountviewController()
    ...
    internal func score1(sender: UIButton){
        ...
        let view1: UIViewController = blackTimecountviewController()
