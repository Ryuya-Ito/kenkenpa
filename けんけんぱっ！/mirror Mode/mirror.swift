...
class mirrorviewController : UIViewController,NADViewDelegate, NADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        score1.addTarget(self, action: "time:",forControlEvents: .TouchUpInside)
    ...
    internal func score(sender: UIButton){
        ...
        let view: UIViewController = mirrorScorecountviewController()
        
        self.presentViewController(view,animated: true, completion: nil)
    }
    //ボタンイベント
    internal func time(sender: UIButton){
        
        NADInterstitialShowResult.self
        NADInterstitial.sharedInstance().showAd()
        
        let view1: UIViewController = mirrorTimecountviewController()
